...
using TouchTest.Web.Providers;
using TouchTest.Web.Results;

namespace TouchTest.Web.Controllers.api
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        {
            ApplicationUser user = await UserManager.FindByIdAsync(Convert.ToInt32(User.Identity.GetUserId()));
